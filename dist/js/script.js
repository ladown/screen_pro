...
window.addEventListener('DOMContentLoaded', function () {
  // HAMBURGER MENU
  var hamburgerBtn = document.querySelector(".header__nav-hamburger");
  var headerMenu = document.querySelector(".header__nav-list");
  var menuItem = document.querySelectorAll(".header__nav-link");
  ...
  var arrowBtn = document.querySelector(".header__contacts-arrowdown");
  var text = document.querySelector(".header__contacts-text");
  var social = document.querySelector(".header__contacts-mess");
